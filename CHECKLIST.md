...
- [x] Alinhar a leitura de `fluency_skill_profiles` ao schema canônico (`evidence_status` e `authoritative_attempt_count`) e impedir regressão por contrato automatizado.
