        ...
        <div class="sentence-container">
          ...
          <div class="media-container">
            <div class="audio-wave-placeholder" id="audio-wave">
              ...
              <span class="wave-bar"></span>
              <span class="wave-bar"></span>
              <button class="btn-play-audio" id="play-audio-btn" aria-label="Ouvir a frase">Ouvir</button>
...
async function loadNextCard(app) {
  ...
  const positionEl = document.getElementById('study-card-position');
  if (positionEl) {
    const totalCards = Math.max(sessionCards + dueQueue.length + pendingLearning.length, sessionCards + 1);
    positionEl.textContent = `${sessionCards + 1} de ${totalCards}`;
  }
