...
|---|---|---|---|---|
| P0 | Versionar migrations já aplicadas e eliminar divergência Git↔Supabase | Codex | Em validação | Todas as migrations conhecidas, inclusive Web Push, estão no Git; falta replay isolado com CLI/Docker. |
