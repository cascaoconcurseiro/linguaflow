...
**Reconciliado em:** 2026-09-10
**Base:** auditoria geral, build `3.0.43` publicado; homologação manual pendente.
...
- [ ] Confirmar no navegador autenticado que `app.js?v=3.0.43` está ativo.
