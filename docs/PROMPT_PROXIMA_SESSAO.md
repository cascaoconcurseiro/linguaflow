...
estado atual no código, nos testes e, quando aplicável, na produção.
...
não estiver autenticado ou a extensão não estiver carregada, registre o
bloqueio e não simule o resultado.

Depois do QA, o próximo capítulo é calibração humana: respostas-âncora, dois
avaliadores independentes, concordância por dimensão, viés e acompanhamento
D7/D30/D90. Não adicionar jogos, refatorar módulos grandes ou escolher TTS
offline antes dessa evidência.
