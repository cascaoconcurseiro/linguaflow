...
assert.match(study, /<details id="iso-context-details" class="context-explanation-card hidden">[\s\S]*?<summary>[\s\S]*?Por que significa isso aqui\?[\s\S]*?id="iso-context-explanation"/,
  'a explicação é uma seção nativa, clicável por mouse e teclado');
