...
INSERT INTO public.cards (id,user_id,word_id,status,reps,due_date,lapses) VALUES
  ('c9000000-0000-4000-8000-000000000001','a9000000-0000-4000-8000-000000000001','b9000000-0000-4000-8000-000000000001','new',0,now()-interval '1 minute',0),
  ('c9000000-0000-4000-8000-000000000002','a9000000-0000-4000-8000-000000000002','b9000000-0000-4000-8000-000000000002','review',0,now()-interval '1 minute',0),
  ('c9000000-0000-4000-8000-000000000003','a9000000-0000-4000-8000-000000000003','b9000000-0000-4000-8000-000000000003','new',0,now()-interval '1 minute',0),
  ('c9000000-0000-4000-8000-000000000004','a9000000-0000-4000-8000-000000000004','b9000000-0000-4000-8000-000000000004','new',0,now()-interval '1 minute',1);
