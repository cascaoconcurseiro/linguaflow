...
const {renderHome}=await import('../../dashboard/js/ui/homeView.js?v=3.0.56');
const {renderStudy}=await import('../../dashboard/js/ui/studyView.js?v=3.0.56');
...
const {renderStories}=await import('../../dashboard/js/ui/storiesView.js?v=3.0.56');
