...
assert.match(db, /'evidence_status'/);
assert.match(db, /'authoritative_attempt_count'/);
assert.doesNotMatch(db, /'confidence_status'/);
assert.doesNotMatch(db, /'evidence_count'/);
