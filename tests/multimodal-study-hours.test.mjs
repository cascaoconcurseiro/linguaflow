...
// 6. Contrato de Cache Busting (PWA / Service Worker v3.0.49)
const swContent = readFileSync('dashboard/sw.js', 'utf8');
assert.match(swContent, /linguaflow-v3\.0\.49/, 'sw.js deve usar a versão de cache 3.0.49');

const dashboardHtml = readFileSync('dashboard/dashboard.html', 'utf8');
assert.match(dashboardHtml, /app\.js\?v=3\.0\.49/, 'dashboard.html deve importar app.js?v=3.0.49');
